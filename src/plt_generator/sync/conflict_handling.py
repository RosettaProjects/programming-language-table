...
def get_matching_titles(titles1: Iterable[str], titles2: Iterable[str]) -> [list[str], list[str]]:
    """
...
def align_titles(titles1: Iterable[str], titles2: Iterable[str]) -> [list[str], list[str]]:
    """
...
def insert_new(alignment: list[tuple[int, int]], titles1: list[str], titles2: list[str]) -> list[str]:
    """
